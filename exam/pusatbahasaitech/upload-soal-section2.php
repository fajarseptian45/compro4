...
/* if( $_SESSION['role'] === "peserta" ){
    echo "
            <script>
                ...
                document.location.href = '../peserta/home.php';
            </script>
         ";
} */
...
$soal_section2 = query("SELECT * FROM `tb_section2`");
?>
...
<head>
    ...
    <title>Upload Soal Section 2</title>
...
<!-- end of side bar -->
                ...
                <div class="container-fluid">
                    ...
                    <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">UPLOAD DATA SOAL SECTION 2</h6>
                  
                        </div>
                        <!-- Begin Page Content -->
                    <div class="card shadow mb-4">
                        <div class="container-fluid">
                            <form method="post" action="upload-soal-section2.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div style="float: right;"><a href="file-upload/sample/data-soal-section2.xlsx" class="btn btn-success">Download Format Excel</a>
                                </div>
                            </div>
                            </form>
                        </div>
    ...
    if (isset($_POST['preview'])) {
       ...
       // $filename = $_POST['file'];
        $nama_file_baru = 'import-soal-section2' . '.xlsx';
        ...
        if ($ext == "xlsx") {
            ...
            echo "<form method='post' action='import-soal-section2.php'>";
