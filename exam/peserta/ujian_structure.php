...
window.onunload=function(){null};
 ...
 <style>
  ...
  //function timer dengan jquery 
    ...
    let countDownDate = new Date(now.getTime() + (1 * 60 * 25 * 1000));
          ...
          <tr>
            ...
            <center><h3>Structure</h3></center>
              <p align="justify">
                  ...
                  <p align="justify">
                  Directions:<br> 
                  In these questions, each sentence has four BOLD words or phrases. The four BOLD parts of the sentence are marked (A), (B), (C), and (D). Identify the one BOLD word or phrase that must be changed in order for the sentence to be correct. Then, on your answer sheet. Find the number of the question and fill in the space that corresponds to the letter of the answer you have chosen.
                  </p>
                  </td>
            </tr>
        </table>
