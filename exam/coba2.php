...
<script src="plugin/countdown/jquery.countdownTimer.js"></script> 
<!-- <script src="plugin/jquery_zoom/jquery.zoom.min.js"></script> -->

<script type="text/javascript">
    var base_url = "coba2.php";
    ...
    selesai = function() {
        ...
        var form  = getFormData(f_asal);
        simpan_akhir(id_tes);
        window.location.assign("coba2.php"+id_tes); 
